      ...
      <section className="bg-gradient-to-br from-blue-900 to-blue-800 text-white py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="text-xl text-gray-200">Nous sommes à votre écoute</p>
          </div>
        </div>
      </section>
          ...
          <div className="grid md:grid-cols-2 gap-12">
            <div>
              ...
              <p className="text-gray-600 mb-8">
                Vous avez des questions sur le projet LUMIÈRE ou souhaitez devenir mécène ? 
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div>
                  ...
                  >
                    ...
                    <option value="mecene">Devenir mécène</option>
              ...
              <div className="space-y-6 mb-8">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">contact@lumiere-hubs.org</p>
                    <p className="text-gray-600">mecenats@lumiere-hubs.org</p>
                  </div>
                </div>
                ...
                <div className="flex space-x-4">
                  {['Facebook', 'Twitter', 'LinkedIn', 'Instagram'].map((social) => (
                    <a
                      key={social}
                      href="#"
                      className="w-12 h-12 bg-gray-200 hover:bg-blue-600 rounded-lg flex items-center justify-center transition-colors group"
                    >
